...
def main(args):
    ...
    if args.dataset == 'MVTec-AD' or args.dataset == 'VisA':
        ...
        train_data = ImageFolder(root=train_path, transform=data_transform)
        test_data = MVTecDataset2_test(root=test_path, transform=infer_transforms, gt_transform=gt_transform, phase="test_public")
    ...
    if args.phase == 'train':
        ...
        for epoch in range(args.total_epochs):
            ...
            if (epoch + 1) % 1 == 0:
                ...
                if f1_px > max_pf1:
                    max_pf1 = f1_px
                    torch.save(model.state_dict(), os.path.join(args.save_dir, args.save_name, args.item, 'model_best_{}_{}.pth'.format(epoch+1,f1_px)))    #TODO
        ...
        auroc_sp, ap_sp, f1_sp, auroc_px, ap_px, f1_px, aupro_px = results
        print_fn( '{}:  P-F1:{:.4f}'.format( args.item, f1_px))
...
if __name__ == '__main__':
    ...
    # save info
    parser.add_argument('--save_dir', type=str, default='./saved_results_single_v4_test')
