...
def get_data_transforms(size, isize, mean_train=None, std_train=None):
    ...
    #     transforms.ColorJitter(saturation=(0.8,1.6)),
    #     # transforms.ColorJitter(brightness=0.2, contrast=0.2, saturation=0.2, hue=0.1)
    # ])
...
class MVTecDataset2(torch.utils.data.Dataset):
    ...
    # def check_download_mvtec2(self, root):
    #     url = "https://www.mydrive.ch/shares/121573/7f68fe2c4f7c2ceaa08f463aaeb2f414/download/466712769-1743422799/mvtec_ad_2.tar.gz"
    #     # 检查root路径是否存在
    #     if not os.path.exists(root):
    #         os.makedirs(root)
    #         print(f"创建目录：{root}")
    #     # 检查root路径是否为空
    #     if os.listdir(root) and root.endswith("mvtec_ad_2"):
    #         return root
    ...
    #         with open(os.path.join(root, 'mvtec_ad_2.tar.gz'), 'wb') as f:
    ...
    #     # 解压数据
    #     print("解压数据...")
    #     tar_path = os.path.join(root, 'mvtec_ad_2.tar.gz')
    #     with tarfile.open(tar_path, 'r:gz') as tar:
    #         tar.extractall(path=root)
    #     print("解压完成！")
    #     # os.remove(tar_path)  # 删除压缩文件
    #     # print("删除压缩文件完成！")
    #     return root
